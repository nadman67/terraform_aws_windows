...
& C:\Packages\healthshare.exe /instance HIWIE /qn INITIALSECURITY=Normal CACHEUSERPASSWORD=j2andUtoo
...
New-NetFirewallRule -DisplayName "HealthShare Studio Port" -Direction Inbound -Action Allow -Protocol TCP -LocalPort 1972
</powershell>